 ...
 */        
    ...
    public static char[] deleteDuplicateChars(String str1, String str2) {
        ...
        // instead of left shifting each index, use 2 pointers of the array and fill in duplicate char with next char    
        int trailingIndex = 0;    
        ...
        //blank out the rest of the array if needed 
        while (trailingIndex < char1.length)
            char1[trailingIndex++] = ' ';
    ...
    /* 79 - delete all duplicated characters in a string and keep only the first occurrence of each character left */
    public static char[] deleteDuplicateCharsExceptFirst(String str) {
        ...
        for (int i = trailingIndex; i < array.length; i++)
            array[i] = ' ';
