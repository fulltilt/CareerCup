...
public class MiscTestCase {
	...
	@Test
	public void testIsCorrespondingSequence() {
	    int[] pushingSequence = {1, 2, 3, 4, 5};
	    int[] poppingSequence1 = {4, 5, 3, 2, 1};
	    int[] poppingSequence2 = {4, 3, 5, 1, 2};
	    assertTrue(Misc.isCorrespondingSequence(pushingSequence, poppingSequence1));
	    assertFalse(Misc.isCorrespondingSequence(pushingSequence, poppingSequence2));		
	}
